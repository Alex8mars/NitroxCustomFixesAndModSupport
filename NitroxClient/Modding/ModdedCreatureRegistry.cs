...
namespace BepInEx
{
    public static class NitroxIntegration
    {
        ...
        {
            NitroxClient.Modding.ModdedCreatureRegistry.Register(new NitroxClient.Modding.ModdedCreatureRegistration(classId, prefabFactory));
        }

        public static void RegisterModdedCreature(NitroxClient.Modding.ModdedCreatureRegistration registration)
        {
            NitroxClient.Modding.ModdedCreatureRegistry.Register(registration);
        }
    }
}
