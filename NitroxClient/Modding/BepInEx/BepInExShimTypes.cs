...
public abstract class BaseUnityPlugin : MonoBehaviour
{
    ...
    internal void InitializeShimContext(BepInPlugin info, ManualLogSource logSource, ConfigFile config)
    {
        Info = info;
        Logger = logSource;
        Config = config;
    ...
    public ConfigFile Config { get; private set; } = ConfigFile.Empty;
}
...
public sealed class PluginInfo
{
    ...
    public ManualLogSource LogSource { get; init; } = Logging.Logger.CreateLogSource("BepInExPlugin");

    public ConfigFile Config { get; init; } = ConfigFile.Empty;
}
